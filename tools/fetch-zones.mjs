...
features.push(
  ...
  },
  {
    ...
    properties: {
      ...
      approx: true,
      note: 'Demonstration watch area on the Helsinki to Tallinn shipping lane, not an official restriction. Sited on open water rather than over a harbor so it shows vessels transiting rather than a list of moored ships.',
...
const out = {
  ...
  meta: {
    ...
    disclaimer: 'NOT FOR NAVIGATION. Prohibited-area geometry is the FAA published boundary, simplified for the browser, but activation times, NOTAMs and temporary restrictions are not modeled. Always use current charts and NOTAMs.',
